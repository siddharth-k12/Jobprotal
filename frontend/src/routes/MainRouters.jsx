...
import Resume from "../pages/candiadate/Resume";
import ATSAnalyzer from "../pages/AI/ATSAnalyzer";
import ATSHistory from "../pages/AI/ATSHistory";
import ATSAnalysisDetails from "../pages/AI/ATSAnalysisDetails";
import ResumeLibrary from "../pages/resume/ResumeLibrary";
import JDMatchAnalyzer from "../pages/AI/JDMatchAnalyzer";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/recruiter/edit-job/:companyId/:jobId"
          element={<EditJob />}
        />
        ...
        {/* AI */}
        <Route path="/ai/ats"element={<ATSAnalyzer />}/>
        <Route
    path="/ai/ats/:jobId"
    element={<ATSAnalyzer />}
/>
...
/>
<Route
    path="/ai/ats/history/:analysisId"
    element={<ATSAnalysisDetails />}
/>
<Route
    path="/resumes"
